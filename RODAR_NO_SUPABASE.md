...
1. Abra https://zpzucupjrzja1gvhyzzxa.supabase.co
2. Vá em **SQL Editor** (lado esquerdo)
3. Clique em **"New query"**

---

## Passo 2: Copie e Cole TODO este SQL
...
Clique no botão **"Run"** (canto inferior direito ou Ctrl+Enter)

Espere a mensagem: ✅ **"completed successfully"** ou similar

---

## ✅ Pronto!

Quando terminar, seu banco tem:
- ✅ 8 tabelas criadas
- ✅ RLS configurado em 100%
- ✅ 3 serviços já cadastrados
- ✅ Horários de funcionamento configurados
- ✅ Funções SQL prontas

**Avise quando terminar e vou testar a conexão!** 🚀
