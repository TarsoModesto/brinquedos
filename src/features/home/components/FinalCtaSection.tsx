...
export function FinalCtaSection() {
  return (
    <section className="relative overflow-hidden rounded-[2.5rem] p-[2px]">
      <div className="absolute inset-0 animate-gradient bg-gradient-fun bg-[length:200%_200%]" aria-hidden />
      <div className="relative rounded-[calc(2.5rem-2px)] bg-white/95 p-10 text-center backdrop-blur dark:bg-slate-950/90 sm:p-14">
        <div className="mx-auto max-w-2xl space-y-5">
          <span className="inline-block rounded-full bg-gradient-to-r from-pink-500 to-orange-400 px-4 py-1.5 text-xs font-black uppercase tracking-wider text-white shadow-soft">
            Pronto para a festa?
          </span>
          ...
          <p className="text-pretty text-slate-600 dark:text-slate-400">
            ...
            transformar o seu evento em uma experiência inesquecível.
          </p>
